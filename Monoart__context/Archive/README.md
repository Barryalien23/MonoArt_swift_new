# 📱 ASCII Camera App — Legacy Android Reference

> **Внимание:** Эти материалы сохранены исключительно как справочник для переноса функциональности на iOS/Swift. Актуальное рабочее пространство находится в `SwiftStarterBundle/`. Используйте данный документ только для анализа исходного Android-приложения и проверки паритета поведения.
